...
public class Eforth201 {	// ooeforth
	...
	static TextArea input = new TextArea("words",20,40);
	static TextArea output = new TextArea("ooeForth 2.01",23,40);

	public static void main(String args[]) {	// ooeforth 2.01
		System.out.println("ooeForth2.01\n");
		// code dictionary 
...
//			put("emit",()->{output.append(""+Character.toChars( stack.pop()));});
			...
			put("words",()->{int i=0;for (var w:dictionary) {
